      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['Load test', 'Concurrent sends + latency stats', 'Postman Runner (limited)'],
            ['Teams & workspaces', 'Shared projects, invites, roles', 'Postman Workspaces'],
            ['Multi-tab', 'Ctrl+T tabs, Ctrl+Enter send', 'Postman tabs'],
          ],
        },
      },
      {
