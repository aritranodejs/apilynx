...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    body { font-family: system-ui, -apple-system, sans-serif; max-width: 900px; margin: 0 auto; padding: 2rem; background: #09090b; color: #e4e4e7; line-height: 1.6; }
...
<body>
  ...
  <p class="meta">Generated by ReqForge · ${now}${baseUrl ? ` · Base: ${escapeHtml(baseUrl)}` : ''}</p>
  ...
  ${requestSections}
  <footer>Developed By Aritra Dutta · ReqForge API Documentation</footer>
</body>
</html>`;
}
